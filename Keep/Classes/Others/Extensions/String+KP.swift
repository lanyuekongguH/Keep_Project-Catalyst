...
extension String {
    ...
    func boundingRectWithSize(_ size: CGSize, _ font: UIFont) -> CGSize {
        ...
        let size = title.boundingRect(with: size, options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [NSAttributedString.Key.font: font], context: nil).size
